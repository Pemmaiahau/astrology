...
export const CONJUNCTION_TEXT: Record<string, string> = {
  "Su-Mo": "Sun–Moon fuses will and feeling into one channel — a self-contained, subjective nature born near the new Moon. Decisiveness is high, but the inner counsel-chamber has one voice; you benefit enormously from advisors you actually consult.",
  ...
  "Su-Ju": "Sun–Jupiter joins the king and the counsellor: dignified wisdom, ethical authority, teaching power. You are asked to lead institutions or at least to bless them. Pride in one's principles is the only inflation risk.",
  "Su-Ve": "Sun–Venus pairs sovereign and artist — creative authority, refined presence, romance complicated by pride. Venus close to combustion strains what the chart promises about marriage; the remedy is letting the partner shine without auditing the wattage.",
  ...
  "Su-Ra": "Sun–Rahu eclipses the ego periodically: outsized ambition for recognition shadowed by crises of legitimacy. There is static around the father. Matured, it gives unconventional authority that rewrites the org chart it was denied a place on.",
  "Su-Ke": "Sun–Ketu quietly detaches the ego from its throne — authority exercised without appetite for it. Identity questions run deep, often father-linked. The strength here is incorruptibility: what you never craved cannot be used to buy you.",
  ...
  "Mo-Sa": "Moon–Saturn chills the inner weather — seriousness, emotional self-rationing, a childhood that taught caution early. Vish-yoga by name, but its mature form is emotional professionalism: you can hold others' grief without drowning.",
  ...
  "Ma-Me": "Mars–Mercury sharpens language into instrument and argument into sport: technical brilliance, debate skill, engineering communication. The enemy-relationship shows as words fired before proofread — the edit button is your job.",
  ...
  "Ma-Sa": "Mars–Saturn yokes the accelerator to the brake — frustration as a chronic climate, and, matured, the rarest of engines: disciplined aggression. Nothing you build under pressure ever falls down. Injuries and grudges heal slowly; both need protocols.",
  ...
  "Ma-Ke": "Mars–Ketu fights without a flag: energy applied in bursts toward goals you cannot always name. Past-life warrior residue shows as instinctive tactical skill and equally instinctive disengagement. Best aimed at technical or spiritual conquest.",
