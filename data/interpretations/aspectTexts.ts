...
export const ASPECT_ON_HOUSE: Record<PlanetId, string[]> = {
  Su: [
    "The Sun's gaze on the Lagna lends the constitution heat, visibility and a spine that does not bend easily; you are seen wherever you stand. It also dries the body's reserves — vitality runs hot and needs deliberate cooling.",
    ...
    "The Sun's aspect on the 3rd steels courage and gives initiative that others follow; skills are pursued for recognition as much as for mastery. Younger siblings may live in your shade or compete with it.",
    "The Sun's glance on the 4th brings prestige to the home and property held in your own name, but it heats the domestic atmosphere: there is an authority in the house and a certain absence of softness. What the chart says about your mother carries the father's or the state's imprint.",
    ...
    "The Sun's gaze on the 7th brings a distinguished, capable partner and public dealings conducted with visible authority. The same heat can crowd the marriage — two sovereigns, one throne — and the partnership prospers only once you learn to share the light.",
    ...
    "Sunlight on the 9th strengthens right living, fortune and the father, granting a natural relationship to teachers, doctrine and purposeful long journeys. Conviction is the strength; certainty is the risk.",
    "The Sun's glance on the 10th is career-defining: status, visibility and authority in the public karma, with government, leadership or institutional recognition following. You are unlikely to work in obscurity.",
  ...
  Mo: [
    ...
    "The Moon's aspect on the 2nd softens speech into persuasion and ties wealth to emotional security — savings rise and fall with your state of mind. Family bonds, especially maternal ones, are the real inheritance here.",
    "Moonlight on the 3rd makes communication warm and instinctive and courage emotional rather than calculated; you act when moved. Siblings are close, and short journeys are undertaken on impulse.",
    "The Moon's glance on the 4th lands on the house the Moon naturally stands for: domestic contentment, a nourishing mother-bond, property that genuinely feels like shelter. The interior life is rich, and its weather is felt by everyone in the house.",
    ...
    "The Moon's gaze on the 6th makes health responsive to mood and gives genuine compassion in service — you care for people rather than processing them. Enemies are handled by absorption rather than confrontation, which works until it does not.",
    "Moonlight on the 7th gives a caring, emotionally attuned partnership and public dealings that read the room accurately. Dependency is the risk: your inner weather can end up outsourced to the partner.",
    ...
    "The Moon's glance on the 9th makes faith a felt thing rather than a doctrine; you are drawn to teachers who move you and to journeys taken for the heart's reasons. Fortune arrives through the goodwill of women and elders.",
    "Moonlight on the 10th gives a public-facing career with genuine popular appeal — the reputation rests on how people feel about you. Work touching the public, care, food, liquids or the mind prospers; consistency of output is the discipline to build.",
    "The Moon's aspect on the 11th builds income through networks that are personal before they are professional, and gains that ebb and flow with your circle. Desires are many and sincerely felt.",
  ...
  Ma: [
    ...
    "Mars's glance on the 5th makes intelligence tactical and competitive, and romance a pursuit rather than a drift. Children are spirited; your own discipline with them decides whether that becomes strength or conflict.",
    ...
    "Mars's glance on the 8th gives surgical capacity, courage in crisis and interest in what lies beneath — but it also makes transformations abrupt. Accidents, surgery and sudden reversals feature; longevity holds once you stop treating risk as recreation.",
    ...
    "Mars's aspect on the 10th lands on the house where Mars is naturally strongest: driving ambition, executive force, and a career built on decisive action — defence, surgery, engineering, sport, enterprise. Authority is seized rather than awaited, and subordinates feel the heat.",
  ...
  Me: [
    "Mercury's gaze on the Lagna gives a youthful, quick-witted presence and a nervous system that runs on information; you are articulate long before you are settled. Adaptability is the strength, dispersion the risk.",
    ...
    "Mercury on the 3rd doubles its own ground — skills, writing, media, short journeys and dexterous hands. Siblings are close and communicative, and your self-effort takes the form of learning.",
    ...
    "Mercury's aspect on the 9th makes higher learning systematic and doctrine something to be examined rather than swallowed; you study the tradition and then question it. Teaching, publishing and scholarly travel are favoured.",
    ...
    "Mercury's gaze on the 12th sends the intellect into private, foreign or research-bound territory — the scholar's cell, the offshore contract, the mind that works best unobserved. Nervous rest matters more here than you usually admit.",
  ],
  Ju: [
    ...
    "Jupiter's aspect on the 2nd blesses wealth, family and speech together — resources accumulate, the family supports, and you are believed when you speak. Generosity outruns budgeting.",
    ...
    "Jupiter's aspect on the 5th lands on the house Jupiter most naturally blesses — wisdom, sound counsel, children who are a blessing, and merit carried in from before this life (purva punya) that pays out now. Intelligence is broad rather than narrow, and you teach naturally.",
    ...
    "Jupiter on the 9th is the guru in the house of the guru: fortune, dharma, higher learning, a benevolent father, and long journeys that enlarge you. Faith here is both inherited and earned.",
    "Jupiter's aspect on the 10th gives an ethical, respected career with advisory or institutional weight — you are trusted with other people's decisions. Advancement comes through reputation more than manoeuvre.",
    ...
    "Jupiter's aspect on the 12th makes expenditure meaningful — charity, pilgrimage, foreign study, real spiritual practice — and protects you in hospitals, in exile and in sleep. The classics count this among the best of the 12th's influences, since it converts loss into liberation.",
  ],
  Ve: [
    "Venus's gaze on the Lagna gives personal charm, a pleasing appearance and an instinct for comfort; people warm to you before they know why. Ease is the gift and, taken too far, the trap.",
    ...
    "Venus on the 4th gives a beautiful, comfortable home, vehicles and property acquired with taste, and an affectionate mother-bond. Domestic contentment is high; you furnish your peace as much as feel it.",
    ...
    "Venus's aspect on the 12th spends on comfort, beauty and private pleasures, and gives the classical blessing on everything the 12th stands for — bed comforts, foreign residence, and the surrender that mature devotion requires. Discretion is the discipline.",
  ],
  Sa: [
    "Saturn's drishti on the Lagna sobers the temperament and slows the body's early flowering; you seem older than your years and come into your own late. What is built on this foundation does not fall down.",
    ...
    "Saturn's glance on the 3rd converts courage into endurance: you outlast rather than outcharge. Effort is sustained over years and skills are mastered by repetition, while relations with siblings carry distance or duty.",
    ...
    "Saturn's aspect on the 6th lands on a house Saturn naturally handles well: chronic enemies wear down, litigation is won by persistence, debts are serviced methodically, and daily discipline is genuinely available. Chronic rather than acute ailments are the health signature.",
    ...
    "Saturn's aspect on the 9th makes dharma a discipline rather than an inheritance: faith is tested, the father carries distance or duty, and the guru is a hard taskmaster. Conviction here is earned and therefore holds.",
    "Saturn's aspect on the 10th lands on the house Saturn naturally stands for, and is one of the strongest career glances in the chart: authority through service, seniority through endurance, and a reputation for reliability that compounds. Advancement is slow and essentially irreversible.",
    ...
    "Saturn's glance on the 12th disciplines expenditure and gives real capacity for solitude, ascetic practice, and work inside institutions, hospitals or foreign postings. Sleep and isolation both need managing; the house's spiritual side — letting go, retreat, liberation (moksha) — is genuinely within reach.",
  ],
  Ra: [
    "Rahu's drishti on the Lagna amplifies the persona and blurs its edges: unusual magnetism, an unconventional self-presentation, and an identity assembled rather than inherited. Other people's projections stick to you easily.",
    ...
    "Rahu's aspect on the 4th unsettles the foundations — a foreign or unconventional home, restlessness about property, and something unsettled around the mother. Inner peace is a project here, not a starting condition.",
    ...
    "Rahu on the 6th is one of its genuinely strong glances: enemies are overwhelmed, competition is relished, and you prosper in litigation, service and the messier arenas others avoid. Diagnoses can be obscure.",
    ...
    "Rahu's aspect on the 9th unsettles inherited belief — unorthodox philosophy, foreign gurus, and a sense of purpose you have to build rather than receive. The father carries distance or disruption.",
    ...
    "Rahu's aspect on the 11th is classically excellent for gains — large, unusual, foreign-sourced income and a network far beyond your origins. Desires, however, refill as fast as they are met.",
  ...
  Ke: [
    "Ketu's drishti on the Lagna gives a detached, self-contained presence and a body you do not much identify with; there is an otherworldliness people notice. Doubt about who one actually is remains the working difficulty.",
    "Ketu's aspect on the 2nd loosens attachment to wealth and family — resources come and go without gripping you, and speech is spare and occasionally cutting. Dietary restriction and family distance both feature.",
    "Ketu's glance on the 3rd makes courage sporadic but instinctive: you act decisively in flashes and disengage between them. Skills are picked up intuitively; sibling ties are karmically loose.",
    ...
    "Ketu on the 6th is among its best glances: enemies simply fall away, debts resolve, and you have an instinctive diagnostic gift in health and service. The ailments themselves can be hard to name.",
    "Ketu's aspect on the 7th introduces detachment into partnership — a spiritually inclined or distant partner, or a marriage you are present for without being attached to. Public dealings are conducted without appetite for approval.",
    "Ketu's glance on the 8th is the planet of letting go in the house of endings and transformation: genuine occult aptitude, ease with mortality and transformation, and sudden events that feel fated rather than accidental. Research runs deep.",
    "Ketu's aspect on the 9th detaches you from inherited religion while deepening the actual practice — the form is discarded, the substance kept. The father or guru may be absent, renunciate, or simply outgrown.",
    "Ketu on the 10th gives a career pursued without hunger for its rewards, often technical, healing or spiritual, and a public standing you are oddly indifferent to. Ambition arrives late, if at all, and the work is better for it.",
    "Ketu's aspect on the 11th thins the network to a few real connections and makes gains erratic — money arrives when needed rather than when pursued. Desires themselves lose their grip, which you may mistake for failure.",
...
export const DRISHTI_CHARACTER: Partial<Record<PlanetId, Record<number, string>>> = {
  Ma: {
    4: "Mars's special 4th-house aspect — Mars at close range, and the most disruptive of its three aspects",
    7: "the full 7th-house aspect every planet casts — in Mars's case direct and unavoidable",
    8: "Mars's special 8th-house aspect — the sudden, wounding one that arrives without notice",
  },
  Ju: {
    5: "Jupiter's special 5th-house aspect — its blessing on intelligence, good counsel and children",
    7: "the full 7th-house aspect every planet casts — in Jupiter's case a direct protection",
    9: "Jupiter's special 9th-house aspect — its blessing on fortune and right living, and the most benevolent aspect there is",
  },
  Sa: {
    3: "Saturn's special 3rd-house aspect — the grinding one, which wears down rather than blocks outright",
    7: "the full 7th-house aspect every planet casts — in Saturn's case direct weight, and the one that delays",
    10: "Saturn's special 10th-house aspect — the aspect of duty imposed and work scrutinised",
  },
  Ra: {
    5: "Rahu's special 5th-house aspect — an amplifier of intelligence and of desire",
    7: "the full 7th-house aspect every planet casts — in Rahu's case direct and obsessive",
    9: "Rahu's special 9th-house aspect — a distorting influence on inherited fortune and belief",
  },
  Ke: {
    5: "Ketu's special 5th-house aspect — a dissolving touch on intelligence and children",
    7: "the full 7th-house aspect every planet casts — in Ketu's case direct detachment",
    9: "Ketu's special 9th-house aspect — a refining influence on fortune and right living",
  },
};
...
export function drishtiCharacter(from: PlanetId, offset: number): string {
  return DRISHTI_CHARACTER[from]?.[offset] ?? "the full 7th-house aspect every planet casts";
}
